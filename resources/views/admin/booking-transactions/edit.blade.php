...
<div class="container mx-auto px-4 py-8">
      <div class="max-w-3xl mx-auto">
            <div class="flex items-center mb-6">
                  ...
                  <h1 class="text-3xl font-bold text-gray-800">Edit Booking Transaction</h1>
            </div>

            <div class="bg-white shadow-md rounded-lg p-6">
                  <form action="{{ route('admin.booking-transactions.update', $bookingTransaction) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                              ...
                              <input type="text"
                                    value="{{ $bookingTransaction->booking_trx_id }}"
                        ...
                        <div class="mb-4">
                              ...
                              <input type="text"
                                    name="name"
                                    id="name"
                                    value="{{ old('name', $bookingTransaction->name) }}"
                        ...
                        <div class="mb-4">
                              ...
                              <input type="text"
                                    name="phone_number"
                                    id="phone_number"
                                    value="{{ old('phone_number', $bookingTransaction->phone_number) }}"
                        ...
                        <div class="mb-4">
                              ...
                              <input type="email"
                                    name="email"
                                    id="email"
                                    value="{{ old('email', $bookingTransaction->email) }}"
                        ...
                        <div class="mb-4">
                              ...
                              <select name="ticket_id"
                                    ...
                                    <option value="{{ $ticket->id }}"
                                          {{ old('ticket_id', $bookingTransaction->ticket_id) == $ticket->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div class="mb-4">
                                    ...
                                    <input type="number"
                                          name="total_amount"
                                          id="total_amount"
                                          value="{{ old('total_amount', $bookingTransaction->total_amount) }}"
                              ...
                              <div class="mb-4">
                                    ...
                                    <input type="number"
                                          ...
                                          value="{{ old('total_participant', $bookingTransaction->total_participant) }}"
                                          min="1"
                        ...
                        <div class="mb-4">
                              ...
                              <input type="date"
                                    name="started_at"
                                    id="started_at"
                                    value="{{ old('started_at', $bookingTransaction->started_at->format('Y-m-d')) }}"
                        ...
                        <div class="mb-4">
                              ...
                              <select name="is_paid"
                                    ...
                                    required>
                                    <option value="0" {{ old('is_paid', $bookingTransaction->is_paid) == '0' ? 'selected' : '' }}>Unpaid</option>
                                    <option value="1" {{ old('is_paid', $bookingTransaction->is_paid) == '1' ? 'selected' : '' }}>Paid</option>
                              </select>
                              @error('is_paid')
                              <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                              @enderror
                        ...
                        <!-- Current Proof -->
                        <div class="mb-4">
                              <label class="block text-gray-700 font-semibold mb-2">Current Payment Proof</label>
                              @if($bookingTransaction->proof)
                              <img src="{{ Storage::url($bookingTransaction->proof) }}"
                                    alt="Payment Proof"
                                    class="w-48 h-48 object-cover rounded-lg border">
                              @else
                              <p class="text-gray-500">No proof uploaded</p>
                              @endif
                        </div>

                        <!-- New Proof -->
                        <div class="mb-6">
                              <label for="proof" class="block text-gray-700 font-semibold mb-2">Upload New Payment Proof (Optional)</label>
                              <input type="file"
                                    name="proof"
                                    id="proof"
                                    accept="image/*"
                              ...
                              <p class="text-sm text-gray-500 mt-1">Leave empty to keep current proof. Max 2MB (JPEG, PNG, JPG)</p>
                              @error('proof')
                              <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                              @enderror
                        </div>
