        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              ...
              @click="selected = (selected === 'Ticket' ? '':'Ticket')"
              class="menu-item group"
              :class=" (selected === 'Ticket') && (page === 'ticket') ? 'menu-item-active' : 'menu-item-inactive'">
              <svg
                :class="(selected === 'Ticket') && (page === 'ticket') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <li>
            <a
              href="{{route('admin.booking-transaction')}}"
              @click="selected = (selected === 'BookingTransaction' ? '':'BookingTransaction')"
              class="menu-item group"
              :class=" (selected === 'BookingTransaction') && (page === 'booking-transaction') ? 'menu-item-active' : 'menu-item-inactive'">
              <svg
                :class="(selected === 'BookingTransaction') && (page === 'booking-transaction') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
